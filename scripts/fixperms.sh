...
echo "Author: PeachFlame, boomshadow, matiniamirhossein,"
echo "        meramsey, ashworthconsulting "
echo "Copyright: GNUv3                     "
echo "Supported: cPanel                    "
echo "Version: 1.0                         "
echo "Original Release Date: 01/09/2022    "
echo "Credits: https://github.com/PeachFlame/cPanel-fixperms"
echo "-------------------------------------"
echo ""
